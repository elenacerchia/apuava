 ...
 */
public enum EnvType implements Env {
   ...
   */
  EnvType(final String name, final String... configFile) {
    this.name = name;
   ...
   * @return The {@link Env} instance matched, otherwise return null if not found.
   */
  public static Optional<Env> fromString(final String value) { //NOPMD
    Optional<Env> matchEnv = Optional.absent();
    for (final Env env : EnvType.values()) {
